...
@section('content')
    <div class="max-w-2xl mx-auto">
        <div class="mb-8">
            ...
            <h1 class="text-3xl font-black tracking-tighter text-zinc-950 uppercase italic">New Category</h1>
        </div>
            ...
            <div class="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm space-y-6">
                <div>
                    <label class="text-[10px] font-black uppercase tracking-widest text-zinc-950 mb-2 block">Category
                        Name</label>
                    <input type="text" name="name" value="{{ old('name') }}" placeholder="e.g. Outerwear"
                ...
                <div>
                    ...
                    <textarea name="description" rows="4" placeholder="Brief info about this category..."
                        class="w-full bg-zinc-50 border-none rounded-xl p-4 text-sm font-bold focus:ring-2 focus:ring-zinc-950">{{ old('description') }}</textarea>
                </div>
                    ...
                    <div class="flex gap-4">
                        <label class="flex-1 cursor-pointer group">
                            ...
                            <div
                                ...
                                <span
                                    class="text-xs font-bold uppercase tracking-widest text-zinc-400 group-hover:text-zinc-600 peer-checked:text-zinc-950">Active</span>
                            </div>
                        </label>
                        <label class="flex-1 cursor-pointer group">
                            ...
                            <div
                                class="p-4 rounded-xl bg-zinc-50 border-2 border-transparent peer-checked:border-zinc-950 peer-checked:bg-white transition-all text-center">
                                <span
                                    class="text-xs font-bold uppercase tracking-widest text-zinc-400 group-hover:text-zinc-600 peer-checked:text-zinc-950">Inactive</span>
                            </div>
                        </label>
                    </div>
                </div>
