    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 py-6 sm:py-12" x-data="{ isEditing: false, avatarPreview: null }" x-cloak>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
            ...
            <div class="lg:col-span-8">
                ...
                {{-- Mobile View: Identity Header --}}
                <div class="lg:hidden flex items-center gap-4 mb-8 bg-zinc-50 p-4 rounded-2xl border border-zinc-100">
                    <div
                    ...
                    <div>
                        <h3 class="text-sm font-black uppercase tracking-tight italic text-zinc-950">{{ $user->name }}
                        </h3>
                        <span class="text-[8px] font-black uppercase tracking-[0.2em] text-zinc-400 block">Verified
                            Client</span>
                    </div>
                </div>
                ...
                <div class="bg-white border border-zinc-100 rounded-3xl p-6 sm:p-8 shadow-sm relative" x-show="!isEditing"
                    ...
                    <h2
                        ...
                        <span class="w-1.5 h-3 bg-zinc-950 block"></span> Akun Profil
                    </h2>
